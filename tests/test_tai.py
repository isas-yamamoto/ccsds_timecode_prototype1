...
class TestTai(unittest.TestCase):
    ...
    def test_zero_time(self):
        expected = 0
        actual = self.handler.total_seconds("1958-01-01T00:00:00Z")
        self.assertEqual(actual, expected)

        elapsed_seconds = 0
        expected = "1958-01-01T00:00:00.000000"
        actual = self.handler.utc_string(elapsed_seconds)
        self.assertEqual(actual, expected)
    ...
    def test_1960_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1960-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1960-12-31T00:00:00.000000"
        actual = self.handler.utc_string(94608000)
        self.assertEqual(actual, expected)
    ...
    def test_1961_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1961-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)
    ...
    def test_1961_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1961-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1961-01-02T00:00:00.000000"
        actual = self.handler.utc_string(94780801.424114)
        self.assertEqual(actual, expected)
    ...
    def test_1961_07_31_utc(self):
        ...
        actual = self.handler.total_seconds("1961-07-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1961-07-31T00:00:00.000000"
        actual = self.handler.utc_string(112924801.696274)
        self.assertEqual(actual, expected)
    ...
    def test_1961_08_01_utc(self):
        ...
        actual = self.handler.total_seconds("1961-08-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1961-08-01T00:00:00.000000"
        actual = self.handler.utc_string(113011201.64757)
        self.assertEqual(actual, expected)
    ...
    def test_1961_08_02_utc(self):
        ...
        actual = self.handler.total_seconds("1961-08-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1961-08-02T00:00:00.000000"
        actual = self.handler.utc_string(113097601.648866)
        self.assertEqual(actual, expected)
    ...
    def test_1961_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1961-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1961-12-31T00:00:00.000000"
        actual = self.handler.utc_string(126144001.844562)
        self.assertEqual(actual, expected)
    ...
    def test_1962_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1962-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1962-01-01T00:00:00.000000"
        actual = self.handler.utc_string(126230401.845858)
        self.assertEqual(actual, expected)
    ...
    def test_1962_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1962-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1962-01-02T00:00:00.000000"
        actual = self.handler.utc_string(126316801.8469812)
        self.assertEqual(actual, expected)
    ...
    def test_1963_10_31_utc(self):
        ...
        actual = self.handler.total_seconds("1963-10-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1963-10-31T00:00:00.000000"
        actual = self.handler.utc_string(183945602.5961556)
        self.assertEqual(actual, expected)
    ...
    def test_1963_11_01_utc(self):
        ...
        actual = self.handler.total_seconds("1963-11-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1963-11-01T00:00:00.000000"
        actual = self.handler.utc_string(184032002.6972788)
        self.assertEqual(actual, expected)
    ...
    def test_1963_11_02_utc(self):
        ...
        actual = self.handler.total_seconds("1963-11-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1963-11-02T00:00:00.000000"
        actual = self.handler.utc_string(184118402.698402)
        self.assertEqual(actual, expected)
    ...
    def test_1963_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1963-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1963-12-31T00:00:00.000000"
        actual = self.handler.utc_string(189216002.7646708)
        self.assertEqual(actual, expected)
    ...
    def test_1964_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1964-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-01-01T00:00:00.000000"
        actual = self.handler.utc_string(189302402.765794)
        self.assertEqual(actual, expected)
    ...
    def test_1964_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1964-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-01-02T00:00:00.000000"
        actual = self.handler.utc_string(189388802.76709)
        self.assertEqual(actual, expected)
    ...
    def test_1964_03_31_utc(self):
        ...
        actual = self.handler.total_seconds("1964-03-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-03-31T00:00:00.000000"
        actual = self.handler.utc_string(197078402.882434)
        self.assertEqual(actual, expected)
    ...
    def test_1964_04_01_utc(self):
        ...
        actual = self.handler.total_seconds("1964-04-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-04-01T00:00:00.000000"
        actual = self.handler.utc_string(197164802.98373)
        self.assertEqual(actual, expected)
    ...
    def test_1964_04_02_utc(self):
        ...
        actual = self.handler.total_seconds("1964-04-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-04-02T00:00:00.000000"
        actual = self.handler.utc_string(197251202.985026)
        self.assertEqual(actual, expected)
    ...
    def test_1964_08_31_utc(self):
        ...
        actual = self.handler.total_seconds("1964-08-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-08-31T00:00:00.000000"
        actual = self.handler.utc_string(210297603.180722)
        self.assertEqual(actual, expected)
    ...
    def test_1964_09_01_utc(self):
        ...
        actual = self.handler.total_seconds("1964-09-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-09-01T00:00:00.000000"
        actual = self.handler.utc_string(210384003.282018)
        self.assertEqual(actual, expected)
    ...
    def test_1964_09_02_utc(self):
        ...
        actual = self.handler.total_seconds("1964-09-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-09-02T00:00:00.000000"
        actual = self.handler.utc_string(210470403.283314)
        self.assertEqual(actual, expected)
    ...
    def test_1964_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1964-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1964-12-31T00:00:00.000000"
        actual = self.handler.utc_string(220838403.438834)
        self.assertEqual(actual, expected)
    ...
    def test_1965_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1965-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-01-01T00:00:00.000000"
        actual = self.handler.utc_string(220924803.54013)
        self.assertEqual(actual, expected)
    ...
    def test_1965_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1965-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-01-02T00:00:00.000000"
        actual = self.handler.utc_string(221011203.541426)
        self.assertEqual(actual, expected)
    ...
    def test_1965_02_28_utc(self):
        ...
        actual = self.handler.total_seconds("1965-02-28T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-02-28T00:00:00.000000"
        actual = self.handler.utc_string(225936003.615298)
        self.assertEqual(actual, expected)
    ...
    def test_1965_03_01_utc(self):
        ...
        actual = self.handler.total_seconds("1965-03-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-03-01T00:00:00.000000"
        actual = self.handler.utc_string(226022403.716594)
        self.assertEqual(actual, expected)
    ...
    def test_1965_03_02_utc(self):
        ...
        actual = self.handler.total_seconds("1965-03-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-03-02T00:00:00.000000"
        actual = self.handler.utc_string(226108803.71789)
        self.assertEqual(actual, expected)
    ...
    def test_1965_06_30_utc(self):
        ...
        actual = self.handler.total_seconds("1965-06-30T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-06-30T00:00:00.000000"
        actual = self.handler.utc_string(236476803.87341)
        self.assertEqual(actual, expected)
    ...
    def test_1965_07_01_utc(self):
        ...
        actual = self.handler.total_seconds("1965-07-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-07-01T00:00:00.000000"
        actual = self.handler.utc_string(236563203.974706)
        self.assertEqual(actual, expected)
    ...
    def test_1965_07_02_utc(self):
        ...
        actual = self.handler.total_seconds("1965-07-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-07-02T00:00:00.000000"
        actual = self.handler.utc_string(236649603.976002)
        self.assertEqual(actual, expected)
    ...
    def test_1965_08_31_utc(self):
        ...
        actual = self.handler.total_seconds("1965-08-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-08-31T00:00:00.000000"
        actual = self.handler.utc_string(241833604.053762)
        self.assertEqual(actual, expected)
    ...
    def test_1965_09_01_utc(self):
        ...
        actual = self.handler.total_seconds("1965-09-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-09-01T00:00:00.000000"
        actual = self.handler.utc_string(241920004.155058)
        self.assertEqual(actual, expected)
    ...
    def test_1965_09_02_utc(self):
        ...
        actual = self.handler.total_seconds("1965-09-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-09-02T00:00:00.000000"
        actual = self.handler.utc_string(242006404.156354)
        self.assertEqual(actual, expected)
    ...
    def test_1965_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1965-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1965-12-31T00:00:00.000000"
        actual = self.handler.utc_string(252374404.311874)
        self.assertEqual(actual, expected)
    ...
    def test_1966_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1966-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1966-01-01T00:00:00.000000"
        actual = self.handler.utc_string(252460804.31317)
        self.assertEqual(actual, expected)
    ...
    def test_1966_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1966-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1966-01-02T00:00:00.000000"
        actual = self.handler.utc_string(252547204.315762)
        self.assertEqual(actual, expected)
    ...
    def test_1968_01_31_utc(self):
        ...
        actual = self.handler.total_seconds("1968-01-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1968-01-31T00:00:00.000000"
        actual = self.handler.utc_string(318124806.28309)
        self.assertEqual(actual, expected)
    ...
    def test_1968_02_01_utc(self):
        ...
        actual = self.handler.total_seconds("1968-02-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1968-02-01T00:00:00.000000"
        actual = self.handler.utc_string(318211206.185682)
        self.assertEqual(actual, expected)
    ...
    def test_1968_02_02_utc(self):
        ...
        actual = self.handler.total_seconds("1968-02-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1968-02-02T00:00:00.000000"
        actual = self.handler.utc_string(318297606.188274)
        self.assertEqual(actual, expected)
    ...
    def test_1971_12_31_utc(self):
        ...
        actual = self.handler.total_seconds("1971-12-31T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1971-12-31T00:00:00.000000"
        actual = self.handler.utc_string(441676809.88965)
        self.assertEqual(actual, expected)
    ...
    def test_1972_01_01_utc(self):
        ...
        actual = self.handler.total_seconds("1972-01-01T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1972-01-01T00:00:00.000000"
        actual = self.handler.utc_string(441763210)
        self.assertEqual(actual, expected)
    ...
    def test_1972_01_02_utc(self):
        ...
        actual = self.handler.total_seconds("1972-01-02T00:00:00Z")
        self.assertAlmostEqual(actual, expected, delta=self.delta)

        expected = "1972-01-02T00:00:00.000000"
        actual = self.handler.utc_string(441849610)
        self.assertEqual(actual, expected)
    ...
    def test_leap_seconds(self):
        ...
        for target in targets:
            ...
            tai1 = self.handler.total_seconds(utcstr1)
            tai2 = self.handler.total_seconds(utcstr2)
            actual = tai2 - tai1
            self.assertEqual(actual, expected)
